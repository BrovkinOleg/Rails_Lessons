...
User.create(name: 'Sara', tests_id: Test.find_by(title: 'Rails', level: 0).id)
User.create(name: 'Jack', tests_id: Test.find_by(title: 'Rails', level: 0).id)
User.create(name: 'Bill', tests_id: Test.find_by(title: 'Rails', level: 0).id)
User.create(name: 'John', tests_id: Test.find_by(title: 'Rails', level: 0).id)
User.create(name: 'John', tests_id: Test.find_by(title: 'Rails', level: 1).id)
User.create(name: 'John', tests_id: Test.find_by(title: 'Rails', level: 2).id)
User.create(name: 'John', tests_id: Test.find_by(title: 'Rails', level: 3).id)
