...
admins = User.create!([{ first_name: 'Admin', last_name: 'Admin', email: 'box@box.ru',
...
tests = Test.create!([
                       ...
                       { title: 'HTML', level: 0, category: categories[1], admin: admins[0] },
...
questions = Question.create!([
                               ...
                               { body: 'question_3', test: tests[1] },
                               { body: 'question_4', test: tests[1] },
                               { body: 'question_5', test: tests[2] },
                               { body: 'question_6', test: tests[2] }
                             ])
